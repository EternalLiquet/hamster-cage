...
| #30 Calendar controls | Review [#65](https://github.com/EternalLiquet/hamster-cage/pull/65) | Two JVM and four hosted API35 calendar CRUD/reopen/failure/restoration checks pass at production-identical 13d1201. Refreshed onto merged policy; exact-head independent gates pending. [Contract](CALENDAR_CONTROLS.md). |
