...
| #17 Permissions | Scoped verification [#56](https://github.com/EternalLiquet/hamster-cage/pull/56) | Real API37 denial/settings/approximate/grant/revocation/location-off checks and staged API routing. All gates passed 538a6be before this status/security integration; current-head gates must renew. Keep issue open for correction editing while permission is denied (#27/#33). [Contract](LOCATION_SETUP.md). |
