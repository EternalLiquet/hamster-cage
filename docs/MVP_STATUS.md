...
| #18 Geofence capture | Implementation | [Capture contract](GEOFENCE_CAPTURE.md): explicit non-exported receiver, enabled-office registration, immutable receipt/observation facts, replay handling and sanitized failures compile; device delivery and independent gates pending. Reboot/coverage boundary is #19 and complete security audit is #20. |
