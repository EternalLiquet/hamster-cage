...
[Issue #80](https://github.com/EternalLiquet/hamster-cage/issues/80) closed after its focused PR restored Today projection from current-day credit and an eligible open session even while older week and rolling coverage are unknown. #78's corrected uncredited arrival grace is also merged. [Issue #79](https://github.com/EternalLiquet/hamster-cage/issues/79) closed after its focused PR clarified unavailable pre-install rolling history. [Issue #88](https://github.com/EternalLiquet/hamster-cage/issues/88) has a scoped software merge for bounded foreground current-presence checks while physical acceptance stays open. [Issue #89](https://github.com/EternalLiquet/hamster-cage/issues/89) is adding inexact weekday background state reconciliation for missed transitions; its local checks do not establish phone or independent acceptance.
