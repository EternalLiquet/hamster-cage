...
[Issue #80](https://github.com/EternalLiquet/hamster-cage/issues/80) closed after its focused PR restored Today projection from current-day credit and an eligible open session even while older week and rolling coverage are unknown. #78's corrected uncredited arrival grace is also merged. [Issue #79](https://github.com/EternalLiquet/hamster-cage/issues/79) closed after its focused PR clarified unavailable pre-install rolling history. [Issue #81](https://github.com/EternalLiquet/hamster-cage/issues/81) is correcting History so pretracking dates do not become default review prompts; independent gates remain pending on its focused draft PR. [Issue #88](https://github.com/EternalLiquet/hamster-cage/issues/88) has a scoped software merge for bounded foreground current-presence checks after office setup or recovery, while physical phone acceptance remains open; it cannot replace physical geofence-delivery acceptance.
