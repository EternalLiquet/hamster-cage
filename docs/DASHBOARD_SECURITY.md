...
- The actual debug APK binary manifest has no INTERNET permission. Both compiled backup resources retain the audited root/database/file/preferences/external/device-protected exclusions. The archive contains no database, preferences file, private-key file or test screenshot. The merged-manifest/source audit and 16 adversarial audit tests pass.
