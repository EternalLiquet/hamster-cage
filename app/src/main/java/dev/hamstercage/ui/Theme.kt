...
/** Shared visual tokens. Reference artwork is deliberately not included in the app. */
object CageStyle {
...
fun HamsterTheme(content: @Composable () -> Unit) {
    MaterialTheme(
        colorScheme = darkColorScheme(
            ...
            secondary = CageStyle.Pink, onSecondary = CageStyle.Background,
        ...
        shapes = Shapes(
            ...
            large = RoundedCornerShape(CageStyle.Radius), extraLarge = RoundedCornerShape(26.dp)
        ),
