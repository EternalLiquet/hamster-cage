...
class CorrectionIntegrationTest {
    @Test fun previewCommitReopenAndRevertKeepFactsWhileRejectingStaleOrInvalidEdits() = runBlocking {
        ...
        try {
            ...
            val correction = Correction("edit", "session:exit", now.minusSeconds(7200), raw.at, now, "Synthetic fix")
            ...
            val marker = correction.copy(id = "revert", start = raw.at, createdAt = now, revertToOriginal = true)
